...
bool isCarWithinBoundingBox(const vec3 &in carPos, const vec3 &in blockCornerPos) {
    ...
    log("isCarWithinBoundingBox: Car at " + carPos.ToString() + " is " + (withinBoundingBox ? "within" : "outside") + " the bounding box of block at " + blockCornerPos.ToString() + ReactorLevel, LogLevel::Info, 298);
